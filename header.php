...
<div id="wrapper">
	...
	<header id="header" class="col-full">
		...
		<div class="header-actions group">
	        <div class="contact-header">
				...
				<a href="#"><span>Call Us</span>
					<?php the_field('footer_number_1' , 'option'); ?>
				</a>
			</div>
			<div class="cart-button">
				<a href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>">
					<span class="fa fa-shopping-cart"></span>
					My Quote ( <b><?php echo WC()->cart->cart_contents_count; ?></b> )
	...
	<nav class="main-nav group" id="main-nav-container">
