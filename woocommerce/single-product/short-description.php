...
<div class="group">
	...
	<div itemprop="description" class="single-prod-desc">
	<!-- <h2 style="font-size:1em">Quick <abbr title="Specifications">Specs</abbr></h2> -->
	...
	<div class="product_meta_desc">
		...
		<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
			...
			<span class="sku_wrapper">
				<?php _e( '<strong>Byler Rivet Part <abbr title="Number">#</abbr></strong>:', 'woocommerce' ); ?>
