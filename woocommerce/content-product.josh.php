...
<li <?php post_class( $classes ); ?>>
	...
	<a href="<?php the_permalink(); ?>" class="prod-detail group <?php if(get_field('hide_image_in_list', $queried_object)) {echo 'no-image';} ?>">
		...
		<div class="prod-content">
			...
			<ul class="prod-meta">
				...
				<li><strong>Mfg Part #</strong> <?php the_field('manufacturer_brand_part_number'); ?></li>
				<?php endif; ?>
				<li><strong>Byler Rivet Part #</strong> <?php echo $product->sku; ?></li>
			</ul>
		</div>
	</a>
