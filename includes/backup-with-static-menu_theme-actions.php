...
<nav id="navigation" class="col-full" role="navigation">
    ...
    <div id="mgmenu1" class="mgmenu_container">
        ...
        <ul class="mgmenu">
			...
			<!-- home -->
            <li><a href="/" title="View Byler Rivet Supply's home page"><span><span class="fa fa-home fa-lg"></span></span></a>
			<!-- /home -->
			<!-- products -->
            <li><a href="#/products/"><span>Products</span></a>
				<!-- products menu container -->
                <!-- <div class="dropdown_fullwidth mgmenu_tabs"> -->
				<div class="dropdown_container mgmenu_tabs">
                    <ul class="mgmenu_tabs_nav">
                        <li><a href="#popular-rivets-tools" class="current">Popular Rivets &amp; Tools</a></li>
                        <li><a href="#adhesives-sealants">Adhesives &amp; Sealans</a></li>
                        <li><a href="#blind-rivets">Blind Rivets</a></li>
                        <li><a href="#bulb-tites-bulbing-rivets">Bulb-tites &amp; Bulbing Rivets</a></li>
                        <li><a href="#drill-bits">Drill Bits</a></li>
                        <li><a href="#drive-rivets">Drive Rivets</a></li>
                        <li><a href="#electrical-products">Electrical Products</a></li>
                        <li><a href="#huck-bolts-lock-bolts">Huck Bolts &amp; Lock Bolts</a></li>
                        <li><a href="#nylon-rivets">Nylon Rivets</a></li>
                        <li><a href="#pop-rivets">Pop Rivets</a></li>
                        <li><a href="#rivet-nuts-inserts">Rivet Nuts &amp; Inserts</a></li>
                        <li><a href="#screws">Screws</a></li>
                        <li><a href="#solid-rivets">Solid Rivets</a></li>
                        <li><a href="#specialty-fasteners">Specialty Fasteners</a></li>
                        <li><a href="#speed-fasteners">Speed Fasteners</a></li>
                        <li><a href="#tools-parts">Tools &amp; Parts</a></li>
                    </ul>
					<!-- panels container -->
                    <div class="mgmenu_tabs_panels">
						<!-- popular rivets and tools (section 1) -->
                        <div id="popular-rivets-tools">
							<p><strong>Popular Rivets &amp; Tools</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /popular rivets and tools (section 1) -->
						<!-- adhesives and sealants (section 2) -->
                        <div id="adhesives-sealants" class="mgmenu_tabs_hide">
							<p><strong>Adhesives &amp; Sealants</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /adhesives and sealants (section 2) -->
						<!-- blind rivets (section 3) -->
                        <div id="blind-rivets" class="mgmenu_tabs_hide">
							<p><strong>Blind Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /blind rivets (section 3) -->
						<!-- bulb-tites and bulbing rivets (section 4) -->
                        <div id="bulb-tites-bulbing-rivets" class="mgmenu_tabs_hide">
							<p><strong>Bulb-tites &amp; Bulbing Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /bulb-tites and bulbing rivets (section 4) -->
						<!-- section 5 -->
                        <div id="drill-bits" class="mgmenu_tabs_hide">
							<p><strong>Drill Bits</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 5 -->
						<!-- section 6 -->
                        <div id="drive-rivets" class="mgmenu_tabs_hide">
							<p><strong>Drive Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 6 -->
						<!-- section 7 -->
                        <div id="electrical-products" class="mgmenu_tabs_hide">
							<p><strong>Electrical Products</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 7 -->
						<!-- section 8 -->
                        <div id="huck-bolts-lock-bolts" class="mgmenu_tabs_hide">
							<p><strong>Huck Bolts &amp; Lockbolts</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 8 -->
						<!-- section 9 -->
                        <div id="nylon-rivets" class="mgmenu_tabs_hide">
							<p><strong>Nylon Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 9 -->
						<!-- section 10 -->
                        <div id="pop-rivets" class="mgmenu_tabs_hide">
							<p><strong>Pop Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 10 -->
						<!-- section 11 -->
                        <div id="rivet-nuts-inserts" class="mgmenu_tabs_hide">
							<p><strong>Rivet Nuts &amp; Inserts</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 11 -->
						<!-- section 12 -->
                        <div id="screws" class="mgmenu_tabs_hide">
							<p><strong>Screws</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 12 -->
						<!-- section 13 -->
                        <div id="solid-rivets" class="mgmenu_tabs_hide">
							<p><strong>Solid Rivets</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 13 -->
						<!-- section 14 -->
                        <div id="specialty-fasteners" class="mgmenu_tabs_hide">
							<p><strong>Specialty Fasteners</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 14 -->
						<!-- section 15 -->
                        <div id="speed-fasteners" class="mgmenu_tabs_hide">
							<p><strong>Speed Fasteners</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
						...
						<!-- /section 15 -->
						<!-- section 16 -->
                        <div id="tools-parts" class="mgmenu_tabs_hide">
							<p><strong>Tools &amp; Parts</strong> <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							<ul>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
								<li class="col_4"><a href="#"><img src="img/product.png" width="90" height="90" alt="Browse A by B" class="inline_img" style="float:left;margin-right:.5em"/> <span class="img_description">category</span></a></li>
            ...
            <!-- <li><a href="#/company/">Company</a> -->
				...
				<!-- <div class="dropdown_2columns dropdown_container">
                    <ul class="dropdown_flyout">
                        ...
                        <li class="dropdown_parent"><a href="#">Javascript</a>
                        ...
                        <li class="dropdown_parent"><a href="#">HTML &amp; CSS</a>
                            <ul class="dropdown_flyout_level">
                                <li><a href="#">Menus</a></li>
                                <li><a href="#">Layouts</a></li>
                                <li><a href="#">Charts</a></li>
                                <li class="dropdown_parent"><a href="#">Web Elements</a>
                                    <ul class="dropdown_flyout_level">
                                        <li><a href="#">Pricing Tables</a></li>
                                        <li><a href="#">Tabs</a></li>
                                        <li><a href="#">Sliders</a></li>
                                        <li class="dropdown_parent dropdown_parent_left"><a href="#">HTML5</a>
                        ...
                        <li><a href="#">Apps</a></li>
                        <li class="dropdown_parent"><a href="#">Wordpress</a>
                            <ul class="dropdown_flyout_level">
                                <li><a href="#">Forms</a></li>
                                <li><a href="#">Galleries</a></li>
                                <li class="dropdown_parent"><a href="#">eCommerce</a>
                                    <ul class="dropdown_flyout_level">
                        ...
                        <li class="last"><a href="#">PHP Scripts</a></li>
                        <li class="flyout_heading">Products</li>
			...
			<!-- /resources -->
			<!-- tool department -->
			<li><a href="#/tool-department/">Tool Department</a>
				<!-- tool department menu container -->
                <div class="dropdown_container dropdown_5columns">
                    <div class="col_12">
                        <h4>Awesome Video !</h4>
			...
			<!-- /tool department -->
			<!-- contact 
				 note: use '<li class="right_item">' to right align in primary navigation menu -->
            <li><a href="#/contact/">Contact</a>
				<!-- contact menu container -->
                <div class="dropdown_container dropdown_4columns dropdown_right" style="float:right;margin-right:0">
                    <div class="col_12">
                        <h4>Contact us !</h4>
                        ...
                        <div class="contact_form" id="contact_form"><!-- Begin Contact Form -->
                            <form method="POST" id="mgmenu_form" action="email.php">
...
//		echo '<strong>' . woo_get_menu_name( 'primary-menu' ) . '</strong>';
...
?>
<strong class="nav-toggle icon"><a href="#navigation"><?php _e( 'Menu', 'woothemes' ); ?></a></strong> <strong class="tel-local-intl"><a href="tel:19729866792">(972)986-6792</a></strong>
<?php
} // End woo_nav_toggle()
}
